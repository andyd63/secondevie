          ...
          <div class="new-arrival-list">
            <ul class="row">
              ...
              <li class="col-md-6"> 
                ...
                <!-- SHOP ITEM 1 -->
                <article> <img class="img-responsive" src="./assets/img/general/boutique/enfantIcone.jpg" alt="">
                ...
                <!-- SHOP ITEM 3 -->
                <article> <img class="img-responsive" src="./assets/img/general/boutique/adulteIcone.jpg" alt="">
                  <div class="position-center-center">
              ...
              <li class="col-md-6"> 
                ...
                <!-- SHOP_ITEM 2 -->
                <article> <img class="img-responsive" src="./assets/img/general/boutique/braderieIcone.jpg" alt="">
                  <div class="position-center-center">
